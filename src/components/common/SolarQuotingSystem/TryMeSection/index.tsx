...
import QuoteConfiguration from '@/components/common/SolarQuotingSystem/TryMeSection/components/QuoteConfiguration';

export default function TryMeSection() {
  const t = useTranslations('quotingSystemPage.tryMeSection');

  return (
    <Box component="section" py={SPACING_DEFAULT_Y} px={SPACING_DEFAULT_X}>
