...
import LeadInfoBlock from '@/components/common/LeadProductInfoSection/components/LeadInfoBlock';
...
export default function LeadProductInfoSection() {
  ...
  return (
    <Box py={SPACING_DEFAULT_Y} px={SPACING_DEFAULT_X} sx={{ backgroundColor: 'grey.50' }}>
